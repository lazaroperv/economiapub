...
<body class="body">
    <?php 
        include("Acciones/cambiarCon.php");
    ?>
    <!-- Metodología BEM -->
    <header>
    ...
    <main>
            ...
            <div class="form-login">
                    <form action="" method="post">
                        ...
                        <h1>Vamos de vuelta!</h1>
                        <div class="casilleross">
                            <!-- Clave -->
                            <input type="password" name="claveNueva"  placeholder="Ingrese su contraseña">
                        </div>

                        <div class="casilleross">
                                <!-- Confirmar Clave -->
                            <input type="password" name="claveNuevaRep"  placeholder="Confirme su contraseña">
                        </div>
                       
                        <div class="botonusu">
                                <!-- Botón -->
                            <input class="botonusuario" type="submit" value="cambiar contraseña" name="cambiar">
                        </div>
